...
> = {
  ...
  marketing:     { label: 'Marketing',     emoji: '🛍️', color: 'purple',  protected: false, defaultAction: 'archive',       order: 2 },
  newsletter:    { label: 'Newsletter',    emoji: '📰', color: 'blue',    protected: false, defaultAction: 'archive',       order: 3 },
  notification:  { label: 'Notification',  emoji: '🔔', color: 'amber',   protected: false, defaultAction: 'archive',       order: 4 },
  social:        { label: 'Social',        emoji: '📱', color: 'pink',    protected: false, defaultAction: 'archive',       order: 5 },
